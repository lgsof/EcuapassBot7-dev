...
class ScrapingDocPdf_Dynamic (ScrapingDocPdf):
	...
	def getPdfCoordinates (self, pdfFilepath):
		print (f"+++ In base class::ScrapingDocPdf_Dynamic... ")
		docType  = Utils.getDocumentTypeFromFilename (pdfFilepath)
		scrapingCLASS = self.getDocTypeCLASS (pdfFilepath)   # Manifiesto or Cartaporte 
	...
	#--------------------------------------------------------------------
	# Abstract Method: Return the Caratporte or Manifiesto CLASS 
	#--------------------------------------------------------------------
	def getDocTypeCLASS (self, pdfFilepath):
		raise NotImplementedError("Subclases deben implementar 'getDocTypeCLASS'")
