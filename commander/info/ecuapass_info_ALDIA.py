...
#----------------------------------------------------------
# Base class for ALDIA's Cartaporte and Manifiesto
#----------------------------------------------------------
class ALDIA:
	#------------------------------------------------------------------
	#-- Two "empresas" ALDIA::SERCARGA and ALDIA::TRANSERCARGA
	#------------------------------------------------------------------
	def getNickname (self):
		textTransportista = self.fields ["01_Transportista"]
		if "TRANSERCARGA" in textTransportista:
			return "ALDIA::TRANSERCARGA"
		elif "SERCARGA" in textTransportista:
			return "ALDIA::SERCARGA"
		else:
			raise IllegalEmpresaException (f"PDFERROR::Empresa no reconocida: '{self.empresa}'")

#----------------------------------------------------------
# Class that gets main info from Ecuapass document 
#----------------------------------------------------------
class Cartaporte_ALDIA (ALDIA, CartaporteInfo):
...
# Class that gets main info from Ecuapass document 
#----------------------------------------------------------
class Manifiesto_ALDIA (ALDIA, ManifiestoInfo):
	def __init__(self, empresa, pais, distrito):
