...
public class InputsView extends javax.swing.JPanel {
  ...
  // End of variables declaration//GEN-END:variables
	...
	public void setController (Controller controller, SettingsController settingsEmpresa) {
		this.controller = controller;
		this.docInputPanel.setController (this);
		this.imageView.setController (controller);
		addFileChooserListeners ();
		fileChooser.setSelectedFile (null);
		String empresa = settingsEmpresa.getValue ("datos", "empresa");
		this.docInputPanel.showDocInfo (empresa, "", "", "");
		// Disable editing for 'empresas' with not URL
		String urlWebsite = settingsEmpresa.getValue ("datos", "urlWebsite");
